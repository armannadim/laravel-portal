    ...
    <div class="hero overlay inner-page">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center text-center pt-5">
                <div class="col-lg-6">
                    <p data-aos="fade-up" class="meta">by <a href="#">{{ $post->user->name }}</a> &bullet; on <a href="#">{{ $post->published_at->format('M d, Y') }}</a> </p>
                    <h1 class="heading text-white mb-3" data-aos="fade-up" data-aos-delay="100">{{ $post->title }}</h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <article class="col-lg-8 order-lg-2 px-lg-5">
                    ...
                    <div class="pt-5">
                        ...
                        <ul class="comment-list">
                            <li class="comment">
                                <div class="vcard bio">
                                    <img src="{{ asset('template') }}/images/person_1.jpg" alt="Image placeholder">
                                </div>
                            ...
                            <li class="comment">
                                <div class="vcard bio">
                                    <img src="{{ asset('template') }}/images/person_2.jpg" alt="Image placeholder">
                                </div>
                                <div class="comment-body">
                                ...
                                <ul class="children">
                                    <li class="comment">
                                        <div class="vcard bio">
                                            <img src="{{ asset('template') }}/images/person_3.jpg" alt="Image placeholder">
                                        </div>
                                        <div class="comment-body">
                                            <h3>Chintan Patel</h3>
                                            <div class="meta">January 9, 2018 at 2:21pm</div>
                ...
                <div class="col-lg-3 mb-5 mb-lg-0 order-lg-3">
                    ...
                    <div class="mb-4">
                        <a href="https://vimeo.com/342333493" class="video-wrap glightbox">
                            ...
                            <img src="{{ asset('template') }}/images/img_1.jpg" alt="Image" class="img-fluid rounded">
                        </a>
                    </div>
