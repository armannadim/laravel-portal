...
@section('content')
    <div class="hero overlay inner-page">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center text-center pt-5">
                <div class="col-lg-6">
                    <h1 class="heading text-white mb-3" data-aos="fade-up">Resources</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section sec-halfs py-0">
        <div class="half-content d-lg-flex align-items-stretch">
            <div class="img" style="background-image: url('{{ asset('template') }}/images/img-1.jpg')" data-aos="fade-in" data-aos-delay="100">
        ...
        <div class="half-content d-lg-flex align-items-stretch">
            <div class="img order-md-2" style="background-image: url('{{ asset('template') }}/images/img-3.jpg')" data-aos="fade-in">
